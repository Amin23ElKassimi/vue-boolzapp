...
createApp({
    data() {
        return {
            ...
            NewMessage: '',
            contacts: [
                        {name: 'Francesco', image: 'img/avatar_2.jpg',
                        visible: true,
                        messages: [
                        {
                        ...
                        {   name: 'Lucy', image: 'https://i.pravatar.cc/47?img=19',
                            visible: true,
                            messages: [
                            {
                                date: '10/01/2020 15:30:55',
                        ...
                        {   name: 'Bernardo Barbucci', image: 'img/avatar_4.jpg',
                        visible: true,
                        messages: [
                        {
                            date: '10/01/2020 15:30:55',
                        ...
                        {   name: 'Annet 🥰', image: 'https://i.pravatar.cc/49?img=49',
                        visible: true,
                        messages: [
                        {
                            date: '10/01/2020 15:30:55',
                        ...
                        {   name: 'Michela Zani', image: 'img/avatar_6.jpg',
                        visible: true,
                        messages: [
                        {
                            date: '10/01/2020 15:30:55',
                            message: "Ciao Michee come va?",
                            status: 'sent'
                        },
                        {
                            date: '10/01/2020 15:50:00',
                            message: 'Ricordati di tornare da San Francisco',
                            status: 'sent'
                        },
                        {
                            date: '10/01/2020 16:15:22',
                            message: 'Ma qui si sta benissimo!!',
                            status: 'received'
                        }
                        ]},
    ...
    methods: {
        ...
        addNewAnswer(newElement){
            const objectMessage = {};
            objectMessage.message = 'Ma che cazzo me ne frega fatti in culo!!🤣🤣';
